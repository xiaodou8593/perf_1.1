#perf:if_block/stone/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class if_block/stone

tellraw @a "--- if_block/stone perf result ---"
...
tellraw @a "if_block/stone perf restart"
data modify storage perf:io afk prepend value "if_block/stone"