#perf:if_block/pass_a_lot/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class if_block/pass_a_lot

tellraw @a "--- if_block/pass_a_lot perf result ---"
...
tellraw @a "if_block/pass_a_lot perf restart"
data modify storage perf:io afk prepend value "if_block/pass_a_lot"