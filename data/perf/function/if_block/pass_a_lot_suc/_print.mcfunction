#perf:if_block/pass_a_lot_suc/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class if_block/pass_a_lot_suc

tellraw @a "--- if_block/pass_a_lot_suc perf result ---"
...
tellraw @a "if_block/pass_a_lot_suc perf restart"
data modify storage perf:io afk prepend value "if_block/pass_a_lot_suc"