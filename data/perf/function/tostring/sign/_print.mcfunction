#perf:tostring/sign/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class tostring/sign

tellraw @a "--- tostring/sign perf result ---"
...
tellraw @a "tostring/sign perf restart"
data modify storage perf:io afk prepend value "tostring/sign"