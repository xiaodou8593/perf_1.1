#perf:tostring/macro/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class tostring/macro

tellraw @a "--- tostring/macro perf result ---"
...
tellraw @a "tostring/macro perf restart"
data modify storage perf:io afk prepend value "tostring/macro"