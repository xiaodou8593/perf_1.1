#perf:compound/cnt_method_1/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class compound/cnt_method_1

tellraw @a "--- compound/cnt_method_1 perf result ---"
...
tellraw @a "compound/cnt_method_1 perf restart"
data modify storage perf:io afk prepend value "compound/cnt_method_1"