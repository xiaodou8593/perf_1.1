#perf:compound/if_key/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class compound/if_key

tellraw @a "--- compound/if_key perf result ---"
...
tellraw @a "compound/if_key perf restart"
data modify storage perf:io afk prepend value "compound/if_key"