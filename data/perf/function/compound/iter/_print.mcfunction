#perf:compound/iter/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class compound/iter

tellraw @a "--- compound/iter perf result ---"
...
tellraw @a "compound/iter perf restart"
data modify storage perf:io afk prepend value "compound/iter"