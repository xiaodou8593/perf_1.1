#perf:compound/cnt_method_3/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class compound/cnt_method_3

tellraw @a "--- compound/cnt_method_3 perf result ---"
...
tellraw @a "compound/cnt_method_3 perf restart"
data modify storage perf:io afk prepend value "compound/cnt_method_3"