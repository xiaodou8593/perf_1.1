#perf:if_score/execute/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class if_score/execute

tellraw @a "--- if_score/execute perf result ---"
...
tellraw @a "if_score/execute perf restart"
