#perf:if_score/predicate_/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class if_score/predicate_

tellraw @a "--- if_score/predicate_ perf result ---"
...
tellraw @a "if_score/predicate_ perf restart"
data modify storage perf:io afk prepend value "if_score/predicate_"