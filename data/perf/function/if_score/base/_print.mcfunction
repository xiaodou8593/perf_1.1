#perf:if_score/base/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class if_score/base

tellraw @a "--- if_score/base perf result ---"
...
tellraw @a "if_score/base perf restart"
