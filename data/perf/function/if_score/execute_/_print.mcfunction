#perf:if_score/execute_/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class if_score/execute_

tellraw @a "--- if_score/execute_ perf result ---"
...
tellraw @a "if_score/execute_ perf restart"
data modify storage perf:io afk prepend value "if_score/execute_"