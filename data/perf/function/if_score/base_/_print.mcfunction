#perf:if_score/base_/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class if_score/base_

tellraw @a "--- if_score/base_ perf result ---"
...
tellraw @a "if_score/base_ perf restart"
data modify storage perf:io afk prepend value "if_score/base_"