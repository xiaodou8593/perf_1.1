#perf:if_score/predicate/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class if_score/predicate

tellraw @a "--- if_score/predicate perf result ---"
...
tellraw @a "if_score/predicate perf restart"
