#perf:string/char_list/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class string/char_list

tellraw @a "--- string/char_list perf result ---"
...
tellraw @a "string/char_list perf restart"
data modify storage perf:io afk prepend value "string/char_list"