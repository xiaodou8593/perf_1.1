#perf:string/compound_list/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class string/compound_list

tellraw @a "--- string/compound_list perf result ---"
...
tellraw @a "string/compound_list perf restart"
data modify storage perf:io afk prepend value "string/compound_list"