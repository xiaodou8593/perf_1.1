#perf:if_data/3/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class if_data/3

tellraw @a "--- if_data/3 perf result ---"
...
tellraw @a "if_data/3 perf restart"
data modify storage perf:io afk prepend value "if_data/3"