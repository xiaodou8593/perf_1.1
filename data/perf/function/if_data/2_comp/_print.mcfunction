#perf:if_data/2_comp/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class if_data/2_comp

tellraw @a "--- if_data/2_comp perf result ---"
...
tellraw @a "if_data/2_comp perf restart"
data modify storage perf:io afk prepend value "if_data/2_comp"