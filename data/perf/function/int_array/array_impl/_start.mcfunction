#perf:int_array/array_impl/_start
# 开始模板测试

# 设置为文件夹名
data modify storage perf:io testing set value "int_array/array_impl"

# 设置测试环境(例如在这里设置实体数量)
data modify storage perf:io int_array set value [I;8, 5, 9]
