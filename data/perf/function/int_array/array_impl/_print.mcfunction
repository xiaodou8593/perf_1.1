#perf:int_array/array_impl/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class int_array/array_impl

tellraw @a "--- int_array/array_impl perf result ---"
...
tellraw @a "int_array/array_impl perf restart"
data modify storage perf:io afk prepend value "int_array/array_impl"