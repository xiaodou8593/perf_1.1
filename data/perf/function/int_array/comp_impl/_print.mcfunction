#perf:int_array/comp_impl/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class int_array/comp_impl

tellraw @a "--- int_array/comp_impl perf result ---"
...
tellraw @a "int_array/comp_impl perf restart"
data modify storage perf:io afk prepend value "int_array/comp_impl"