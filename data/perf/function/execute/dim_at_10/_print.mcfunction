#perf:execute/dim_at_10/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class execute/dim_at_10

tellraw @a "--- execute/dim_at_10 perf result ---"
...
tellraw @a "execute/dim_at_10 perf restart"
data modify storage perf:io afk prepend value "execute/dim_at_10"