#perf:execute/dim_as_8/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class execute/dim_as_8

tellraw @a "--- execute/dim_as_8 perf result ---"
...
tellraw @a "execute/dim_as_8 perf restart"
data modify storage perf:io afk prepend value "execute/dim_as_8"