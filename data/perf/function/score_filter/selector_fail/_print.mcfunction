#perf:score_filter/selector_fail/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class score_filter/selector_fail

tellraw @a "--- score_filter/selector_fail perf result ---"
...
tellraw @a "score_filter/selector_fail perf restart"
