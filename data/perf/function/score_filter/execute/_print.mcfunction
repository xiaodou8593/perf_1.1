#perf:score_filter/execute/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class score_filter/execute

tellraw @a "--- score_filter/execute perf result ---"
...
tellraw @a "score_filter/execute perf restart"
