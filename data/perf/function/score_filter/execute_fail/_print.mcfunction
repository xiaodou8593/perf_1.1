#perf:score_filter/execute_fail/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class score_filter/execute_fail

tellraw @a "--- score_filter/execute_fail perf result ---"
...
tellraw @a "score_filter/execute_fail perf restart"
