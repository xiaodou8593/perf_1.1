#perf:score_filter/selector/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class score_filter/selector

tellraw @a "--- score_filter/selector perf result ---"
...
tellraw @a "score_filter/selector perf restart"
