#perf:uvw/anchorto/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class uvw/anchorto

tellraw @a "--- uvw/anchorto perf result ---"
...
tellraw @a "uvw/anchorto perf restart"
data modify storage perf:io afk prepend value "uvw/anchorto"