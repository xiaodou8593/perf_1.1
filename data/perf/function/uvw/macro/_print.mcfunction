#perf:uvw/macro/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class uvw/macro

tellraw @a "--- uvw/macro perf result ---"
...
tellraw @a "uvw/macro perf restart"
data modify storage perf:io afk prepend value "uvw/macro"