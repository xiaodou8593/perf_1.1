#perf:uvw/void/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class uvw/void

tellraw @a "--- uvw/void perf result ---"
...
tellraw @a "uvw/void perf restart"
data modify storage perf:io afk prepend value "uvw/void"