#perf:uvw/tovec/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class uvw/tovec

tellraw @a "--- uvw/tovec perf result ---"
...
tellraw @a "uvw/tovec perf restart"
data modify storage perf:io afk prepend value "uvw/tovec"