...
$execute if score perf_loop int matches 1.. run function $(namespace)$(testing)/loop
...
data modify storage perf:io list_res append value 0
execute store result storage perf:io list_res[-1] int 1 run scoreboard players get res int
