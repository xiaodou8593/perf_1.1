#perf:data/iter/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class data/iter

tellraw @a "--- data/iter perf result ---"
...
tellraw @a "data/iter perf restart"
data modify storage perf:io afk prepend value "data/iter"