#perf:data/iter_macro/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class data/iter_macro

tellraw @a "--- data/iter_macro perf result ---"
...
tellraw @a "data/iter_macro perf restart"
data modify storage perf:io afk prepend value "data/iter_macro"