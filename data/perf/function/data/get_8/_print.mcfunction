#perf:data/get_8/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class data/get_8

tellraw @a "--- data/get_8 perf result ---"
...
tellraw @a "data/get_8 perf restart"
data modify storage perf:io afk prepend value "data/get_8"