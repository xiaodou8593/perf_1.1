#perf:data/index/base/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class data/index/base

tellraw @a "--- data/index/base perf result ---"
...
tellraw @a "data/index/base perf restart"
