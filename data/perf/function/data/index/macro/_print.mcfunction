#perf:data/index/macro/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class data/index/macro

tellraw @a "--- data/index/macro perf result ---"
...
tellraw @a "data/index/macro perf restart"
