#perf:data/get_4/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class data/get_4

tellraw @a "--- data/get_4 perf result ---"
...
tellraw @a "data/get_4 perf restart"
data modify storage perf:io afk prepend value "data/get_4"