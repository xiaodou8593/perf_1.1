#perf:data/set_from/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class data/set_from

tellraw @a "--- data/set_from perf result ---"
...
tellraw @a "data/set_from perf restart"
data modify storage perf:io afk prepend value "data/set_from"