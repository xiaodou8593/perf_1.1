#perf:data/get_16/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class data/get_16

tellraw @a "--- data/get_16 perf result ---"
...
tellraw @a "data/get_16 perf restart"
data modify storage perf:io afk prepend value "data/get_16"