#perf:data/get_1/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class data/get_1

tellraw @a "--- data/get_1 perf result ---"
...
tellraw @a "data/get_1 perf restart"
data modify storage perf:io afk prepend value "data/get_1"