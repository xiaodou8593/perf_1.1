#perf:tag/remove_method1/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class tag/remove_method1

tellraw @a "--- tag/remove_method1 perf result ---"
...
tellraw @a "tag/remove_method1 perf restart"
data modify storage perf:io afk prepend value "tag/remove_method1"