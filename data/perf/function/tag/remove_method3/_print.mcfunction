#perf:tag/remove_method3/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class tag/remove_method3

tellraw @a "--- tag/remove_method3 perf result ---"
...
tellraw @a "tag/remove_method3 perf restart"
data modify storage perf:io afk prepend value "tag/remove_method3"