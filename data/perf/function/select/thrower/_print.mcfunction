#perf:select/thrower/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class select/thrower

tellraw @a "--- select/thrower perf result ---"
...
tellraw @a "select/thrower perf restart"
data modify storage perf:io afk prepend value "select/thrower"