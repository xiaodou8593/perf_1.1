#perf:select/ate/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class select/ate

tellraw @a "--- select/ate perf result ---"
...
tellraw @a "select/ate perf restart"
data modify storage perf:io afk prepend value "select/ate"