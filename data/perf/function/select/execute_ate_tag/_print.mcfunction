#perf:select/execute_ate_tag/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class select/execute_ate_tag

tellraw @a "--- select/execute_ate_tag perf result ---"
...
tellraw @a "select/execute_ate_tag perf restart"
data modify storage perf:io afk prepend value "select/execute_ate_tag"