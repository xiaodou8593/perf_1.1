#perf:select/ate_tag_2000/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class select/ate_tag_2000

tellraw @a "--- select/ate_tag_2000 perf result ---"
...
#tellraw @a "select/ate_tag_2000 perf restart"
#data modify storage perf:io afk prepend value "select/ate_tag_2000"