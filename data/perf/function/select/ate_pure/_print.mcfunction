#perf:select/ate_pure/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class select/ate_pure

tellraw @a "--- select/ate_pure perf result ---"
...
tellraw @a "select/ate_pure perf restart"
data modify storage perf:io afk prepend value "select/ate_pure"