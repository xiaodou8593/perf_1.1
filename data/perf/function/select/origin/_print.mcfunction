#perf:select/origin/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class select/origin

tellraw @a "--- select/origin perf result ---"
...
tellraw @a "select/origin perf restart"
data modify storage perf:io afk prepend value "select/origin"