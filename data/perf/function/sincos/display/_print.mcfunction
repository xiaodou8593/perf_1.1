#perf:sincos/display/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class sincos/display

tellraw @a "--- sincos/display perf result ---"
...
tellraw @a "sincos/display perf restart"
data modify storage perf:io afk prepend value "sincos/display"