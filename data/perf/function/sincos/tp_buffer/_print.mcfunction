#perf:sincos/tp_buffer/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class sincos/tp_buffer

tellraw @a "--- sincos/tp_buffer perf result ---"
...
tellraw @a "sincos/tp_buffer perf restart"
data modify storage perf:io afk prepend value "sincos/tp_buffer"