#perf:sincos/display_buffer/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class sincos/display_buffer

tellraw @a "--- sincos/display_buffer perf result ---"
...
tellraw @a "sincos/display_buffer perf restart"
data modify storage perf:io afk prepend value "sincos/display_buffer"