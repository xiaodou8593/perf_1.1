#perf:sincos/tp/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class sincos/tp

tellraw @a "--- sincos/tp perf result ---"
...
tellraw @a "sincos/tp perf restart"
data modify storage perf:io afk prepend value "sincos/tp"