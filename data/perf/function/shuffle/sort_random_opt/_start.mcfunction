#perf:shuffle/sort_random_opt/_start
# 开始模板测试

# 设置为文件夹名
data modify storage perf:io testing set value "shuffle/sort_random_opt"

# 设置测试环境(例如在这里设置实体数量)
scoreboard players set inp int 25
execute positioned 0 0 0 run function perf:_entities
scoreboard players set marker_pool_vol int 100
