#perf:shuffle/sort_random/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class shuffle/sort_random

tellraw @a "--- shuffle/sort_random perf result ---"
...
tellraw @a "shuffle/sort_random perf restart"
