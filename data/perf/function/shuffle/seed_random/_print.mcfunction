#perf:shuffle/seed_random/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class shuffle/seed_random

tellraw @a "--- shuffle/seed_random perf result ---"
...
tellraw @a "shuffle/seed_random perf restart"
