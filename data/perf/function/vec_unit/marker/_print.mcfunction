#perf:vec_unit/marker/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class vec_unit/marker

tellraw @a "--- vec_unit/marker perf result ---"
...
tellraw @a "vec_unit/marker perf restart"
data modify storage perf:io afk prepend value "vec_unit/marker"