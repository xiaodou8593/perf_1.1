#perf:vec_unit/sqrt/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class vec_unit/sqrt

tellraw @a "--- vec_unit/sqrt perf result ---"
...
tellraw @a "vec_unit/sqrt perf restart"
data modify storage perf:io afk prepend value "vec_unit/sqrt"