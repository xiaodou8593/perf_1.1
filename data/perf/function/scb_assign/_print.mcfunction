#perf:scb_assign/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class scb_assign

tellraw @a "--- scb_assign perf result ---"
...
tellraw @a "scb_assign perf restart"
data modify storage perf:io afk prepend value "scb_assign"