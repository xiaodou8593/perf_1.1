#perf:tp/dim_test/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class tp/dim_test

tellraw @a "--- tp/dim_test perf result ---"
...
tellraw @a "tp/dim_test perf restart"
data modify storage perf:io afk prepend value "tp/dim_test"