...
data modify storage perf:io temp set from storage perf:class tp/base

tellraw @a "--- tp/base perf result ---"
...
tellraw @a "tp/base perf restart"
data modify storage perf:io afk prepend value "tp/base"