#perf:scb_swap/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class scb_swap

tellraw @a "--- scb_swap perf result ---"
...
tellraw @a "scb_swap perf restart"
data modify storage perf:io afk prepend value "scb_swap"