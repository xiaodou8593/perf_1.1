#perf:execute_positioned/_print
# 输出测试数据

data modify storage perf:io temp set from storage perf:class execute_positioned

tellraw @a "--- execute_positioned perf result ---"
...
tellraw @a "execute_positioned perf restart"
data modify storage perf:io afk prepend value "execute_positioned"